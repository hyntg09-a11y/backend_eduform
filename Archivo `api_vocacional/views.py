...
class EvaluacionViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        evaluacion = self._create_evaluacion(request)
    ...
    def responder(self, request, pk=None):
        ...
        if serializer.is_valid():
            ...
            self._register_response(evaluacion, serializer.validated_data)
    ...
    def _create_evaluacion(self, request):
    ...
    def _register_response(self, evaluacion, data):
